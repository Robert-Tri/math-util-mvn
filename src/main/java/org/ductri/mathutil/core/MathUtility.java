 ...
 */
package org.ductri.mathutil.core;
...
public class MathUtility {
    ...
    //class này chưa hàm static, chấm xài luôn
    //tính n! = 1.2.3...n
    //quy ước thiết kế hàm này nư sau
    //0! = 1! = 1
...
//        if (n < 0 || n > 20) 
//            throw new IllegalArgumentException("Invalid n. n must be betwween 0..20, pls");
//        
//        if(n == 0 || n == 1)
//            return 1;
//        
...
//TDD: Test Driven Development: code hàm -> test hàm luôn
//code đến đâu kiểm thử đến đó, viết code và viết testcase/ testrun
//diển ra song song, đan xen

//cứ có hàm là có test case
//viết ra các test case đủ bao quát các tình huống xài hàm
//test case là bộ dữ liệu để đưa vào app/hàm để mô phỏng lại
